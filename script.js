...
(()=>{
 ...
 shell.innerHTML=`
  <button class="leadbot-launch" type="button" aria-label="Open free estimate assistant" aria-expanded="false"><span aria-hidden="true">✦</span><b>Free Estimate</b></button>
